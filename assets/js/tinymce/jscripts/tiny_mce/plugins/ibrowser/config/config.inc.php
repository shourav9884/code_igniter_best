...
/*		array (
	...
	$cfg['ilibs'] = array (																// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions	
		array (																		
			'value'   	=> '/cse/csefest2013/assets/pictures/',												
			'text'    	=> 'Site Pictures',
		),
		array (
			'value'   	=> '/cse/csefest2013/assets/pictures/',				
	...
	$cfg['ilibs_dir'] 	   = array('/editor/images/');						   	// image library path with slashes; absolute to root directory - please make sure that the directories have write permissions
	...
	$cfg['base_url'] 	= 'http://buet.ac.bd';//'http://' . $_SERVER['SERVER_NAME'].':'.$_SERVER['SERVER_PORT']; 							// base url; e.g. 'http://localhost/'	
