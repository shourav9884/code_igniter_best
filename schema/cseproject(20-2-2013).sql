...
--
-- Host: localhost
-- Generation Time: Feb 20, 2013 at 01:58 PM
...
--
-- Table structure for table `csefest2013_acm_teams`
--

CREATE TABLE IF NOT EXISTS `csefest2013_acm_teams` (
...
--
-- Dumping data for table `csefest2013_acm_teams`
--

INSERT INTO `csefest2013_acm_teams` (`team_id`, `team_name`, `registration_date_time`, `status`) VALUES
...
--
-- Table structure for table `csefest2013_acm_team_members`
--

CREATE TABLE IF NOT EXISTS `csefest2013_acm_team_members` (
...
--
-- Dumping data for table `csefest2013_acm_team_members`
--

INSERT INTO `csefest2013_acm_team_members` (`member_id`, `team_id`, `batch`, `student_id`, `name`, `email`, `department`, `phone`, `address`) VALUES
...
--
-- Dumping data for table `csefest2013_admin_login`
--

INSERT INTO `csefest2013_admin_login` (`id`, `email`, `password`) VALUES
(1, 'sujon335@yahoo.com', '827ccb0eea8a706c4c34a16891f84e7b');

-- --------------------------------------------------------

--
-- Table structure for table `csefest2013_alumni`
--

CREATE TABLE IF NOT EXISTS `csefest2013_alumni` (
...
--
-- Table structure for table `csefest2013_bsadd_contests`
--

CREATE TABLE IF NOT EXISTS `csefest2013_bsadd_contests` (
...
--
-- Dumping data for table `csefest2013_bsadd_contests`
--

INSERT INTO `csefest2013_bsadd_contests` (`contest_id`, `field`, `last_date_time`, `ranklist`) VALUES
...
--
-- Table structure for table `csefest2013_bsadd_contest_teams`
--

CREATE TABLE IF NOT EXISTS `csefest2013_bsadd_contest_teams` (
  `team_id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `csefest2013_bsadd_contest_teams`
--

INSERT INTO `csefest2013_bsadd_contest_teams` (`team_id`, `contest_id`, `team_name`, `institution`, `department`, `session`, `registration_date_time`, `status`, `payment_status`) VALUES
...
--
-- Table structure for table `csefest2013_bsadd_contest_team_members`
--

CREATE TABLE IF NOT EXISTS `csefest2013_bsadd_contest_team_members` (
  `member_id` int(11) NOT NULL AUTO_INCREMENT,
  `team_id` int(11) NOT NULL,
...
--
-- Dumping data for table `csefest2013_bsadd_contest_team_members`
--

INSERT INTO `csefest2013_bsadd_contest_team_members` (`member_id`, `team_id`, `student_id`, `name`, `email`, `phone`, `address`) VALUES
...
--
-- Table structure for table `csefest2013_bsadd_contest_winners`
--

CREATE TABLE IF NOT EXISTS `csefest2013_bsadd_contest_winners` (
...
--
-- Dumping data for table `csefest2013_bsadd_contest_winners`
--

INSERT INTO `csefest2013_bsadd_contest_winners` (`contest_id`, `first_team_name`, `second_team_name`, `third_team_name`) VALUES
...
(6, 'gallery-5', '', 'http://localhost:9090/csefest/assets/gallery/21.jpg'),
(7, 'gallery-7', 'The  moment , youth took their pride .', 'http://localhost:9090/csefest/assets/gallery/4.jpg'),
(8, 'Gallery-Image-6', '', 'http://localhost:9090/csefest/assets/gallery/11.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `csefest2013_online_games`
--

CREATE TABLE IF NOT EXISTS `csefest2013_online_games` (
...
--
-- Table structure for table `csefest2013_online_game_members`
--

CREATE TABLE IF NOT EXISTS `csefest2013_online_game_members` (
  `member_id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `csefest2013_pages`
--

CREATE TABLE IF NOT EXISTS `csefest2013_pages` (
...
--
-- Dumping data for table `csefest2013_pages`
--

INSERT INTO `csefest2013_pages` (`page_id`, `title`, `content`) VALUES
...
--
-- Table structure for table `csefest2013_projects`
--

CREATE TABLE IF NOT EXISTS `csefest2013_projects` (
...
--
-- Dumping data for table `csefest2013_projects`
--

INSERT INTO `csefest2013_projects` (`project_id`, `project_type`, `project_name`, `registration_date_time`, `status`, `payment_status`) VALUES
...
--
-- Table structure for table `csefest2013_project_members`
--

CREATE TABLE IF NOT EXISTS `csefest2013_project_members` (
  `member_id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `csefest2013_project_members`
--

INSERT INTO `csefest2013_project_members` (`member_id`, `project_id`, `student_id`, `name`, `email`, `institution`, `department`, `session`, `phone`, `address`) VALUES
...
--
-- Table structure for table `csefest2013_sports`
--

CREATE TABLE IF NOT EXISTS `csefest2013_sports` (
...
--
-- Dumping data for table `csefest2013_sports`
--

INSERT INTO `csefest2013_sports` (`sport_id`, `name`) VALUES
(1, 'Ludu'),
(2, 'Table Tennis');
...
--
-- Table structure for table `csefest2013_sport_members`
--

CREATE TABLE IF NOT EXISTS `csefest2013_sport_members` (
  `member_id` int(11) NOT NULL AUTO_INCREMENT,
